...
<div class="navbar navbar-inverse navbar-fixed-top">
    ...
    <div class="container">
        ...
        <div>
            ...
            <!--退出登录-->
            <a href="/RemoveSessionServlet" class="btn btn-danger navbar-btn navbar-right">退出登录</a>
            <!--退出登录-->
    ...
    <div class="row">
        ...
        <div class="col-md-10 tab-content">
            ...
            <div id="news" class="active tab-pane embed-responsive embed-responsive-16by9">
                <!-- 使用内嵌框架事件页面的跳转 -->
                <iframe id="iNews" class="embed-responsive-item" src="/NewsServlet"></iframe>
            </div>
            <!-- 最新通知结束 -->

            <!-- 我的预定开始 -->
            <div id="myOrder" class="tab-pane embed-responsive embed-responsive-16by9">
                <iframe id="iMyorder" class="embed-responsive-item" src="/BookMeetingServlet"></iframe>
            </div>
            <!-- 我的预定结束 -->

            <!--我的会议开始-->
            <div id="meeting" class="tab-pane embed-responsive embed-responsive-16by9">
                <iframe id="iMeeting" class="embed-responsive-item" src="/BookMeetingServlet"></iframe>
            </div>
            <!-- 我的会议结束 -->
            ...
            <div id="selEmp" class="tab-pane embed-responsive embed-responsive-16by9">
                <iframe id="iSelEmp" class="embed-responsive-item" src="/SearchEmployeeServlet></iframe>
            </div>
            <!-- 搜素员工结束 -->
            ...
            <div id="search" class="tab-pane embed-responsive embed-responsive-16by9">
                <iframe id="iSearch" class="embed-responsive-item" src="/SearchMeetingServlet"></iframe>
            </div>
            <!-- 会议搜索结束 -->
        </div>
        <!-- 主内容区结束 -->
